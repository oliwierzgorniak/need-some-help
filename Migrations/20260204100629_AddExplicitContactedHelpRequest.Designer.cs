...
namespace NeedSomeHelp.Migrations
{
    ...
    [Migration("20260204100629_AddExplicitContactedHelpRequest")]
    partial class AddExplicitContactedHelpRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NeedSomeHelp.Data.ContactedHelpRequest", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ContactedUserRequests");
                });
            ...
            modelBuilder.Entity("NeedSomeHelp.Data.ContactedHelpRequest", b =>
                {
                    ...
                    b.HasOne("NeedSomeHelp.Data.ApplicationUser", "User")
                        .WithMany("ContactedRequests")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("NeedSomeHelp.Data.ApplicationUser", b =>
                {
                    b.Navigation("ContactedRequests");
